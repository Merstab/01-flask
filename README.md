...
// text needs to be changed "Both [serum-rest-server](https://github.com/project-serum/serum-rest-server) and [@project-serum/serum](https://github.com/project-serum/serum-ts/tree/master/packages/serum) provide such functionality and are recommended alternatives."
...
// text needs to be changed: "01-flask public hosted WebSocket server (backed by Project Serum RPC node) is available at:"
...
| `markets-json`                                                                                                                                                                                                                                                                                          | `@project-serum/serum` [markets.json](https://github.com/project-serum/serum-ts/blob/master/packages/serum/src/markets.json) file, but only non depreciated markets | path to custom market.json definition file if one wants to run s01-flask for custom markets                                                                                                       |
...
| `SV_ENDPOINT`                                                                                                                                                                                                                                                                                           | https://solana-api.projectserum.com                                                                                                                                 | Solana RPC node endpoint that 01-flask uses as a data source                                                                                                                                     |
...
| `SV_MARKETS_JSON`                                                                                                                                                                                                                                                                                       | `@project-serum/serum` [markets.json](https://github.com/project-serum/serum-ts/blob/master/packages/serum/src/markets.json) file, but only non depreciated markets | path to custom market.json definition file if one wants to run 01-flask for custom markets                                                                                                       |
